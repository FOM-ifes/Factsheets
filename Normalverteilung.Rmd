...
gf_dist("norm", mean = 0, sd=1, kind = "cdf") %>% 
  gf_labs(title = "Verteilungsfunktion", 
          subtitle = bquote(mu ~ "= 0, " ~ sigma ~ "= 1"), x="x", y=expression(paste("F(x)=P(",X<=x,")")))
```
...
- $68$-$95$-$99{,}7\,\%$-Regel: Bei Normalverteilung 
  - $P\left(\mu-1 \cdot \sigma \leq x \leq \mu+1 \cdot \sigma\right) \approx 68\,\%$
  - $P\left(\mu-2 \cdot \sigma \leq x \leq \mu+2 \cdot \sigma\right) \approx 95\,\%$
  - $P\left(\mu-3 \cdot \sigma \leq x \leq \mu+3 \cdot \sigma\right) \approx 99{,}7\,\%$
