...
Die angegebene Sicherheit bezieht sich auf das Verfahren: Bei wiederholter Stichprobenziehung den Anteil der so konstruierten Konfidenzintervalle, die den wahren, festen Wert in der Population enthalten.
