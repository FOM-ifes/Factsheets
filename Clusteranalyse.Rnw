...
\end{equation*}
\item Niedriger WCSS-Wert: Die Beobachtungen innerhalb jedes Clusters liegen näher beieinander und weisen eine höhere Dichte auf.
\item Hoher WCSS-Wert: Die Beobachtungen liegen weiter voneinander entfernt und weisen eine niedrigere Dichte auf.
\end{compactitem}
